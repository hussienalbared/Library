...
public class bookModels {
    ...
    public bookModels(int isbnb, int yearB, String titleb, String authorb, String updaterb) {
        this.isbnb = isbnb;
        this.yearB = yearB;
        this.titleb = titleb;
    ...
    public ArrayList<bookModels>getMyBorrowedBooks(String userEmail)throws SQLException
    {
        
        Connection con=DBConnection.getActiveConnection();
        String query="select * from books,borrowedbook where ISBN=bookISBN and userEmail=?";
      ...
      while(rs.next())
      {
         arr.add(new bookModels(rs.getInt("ISBN"), rs.getInt("Publication_Year"),rs.getString("Title"),
                 rs.getString("Author"), rs.getString("LastUpdater")));
    ...
    public void addBook(String title,String author,int isbn,int year,String updater  ) throws SQLException
    {
       
        Connection con=DBConnection.getActiveConnection();
        String qwery = "insert into books (ISBN,Title,Author,LastUpdater,Publication_Year) values(?,?,?,?,?)";
...
stm.setInt(1, isbn);
  ...
  stm.execute();
    ...
    public void UpdateBook(String title,String author,int isbn,int year,String updater)throws SQLException
    {
        Connection con=DBConnection.getActiveConnection();
     String query="update  books set Author=? ,title =?,Publication_Year=?,LastUpdater=? where ISBN=?";
               PreparedStatement stm=con.prepareStatement(query);
